    ...
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-b from-[#0c0c1e] to-[#121232] text-white font-sans w-full ">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-[#0c0c1e] shadow-md">
        ...
        <nav className="space-x-6 text-sm">
          ...
          <Link to="/#equipe" className="hover:text-blue-400 transition">Équipes</Link>
          <Link to="/#evenements" className="hover:text-blue-400 transition">Événements</Link>
          <Link to="/#partenaire" className="hover:text-blue-400 transition">Partenaire</Link>
          <Link to="/#benevole" className="hover:text-blue-400 transition">Bénévole</Link>
