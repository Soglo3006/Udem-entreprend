  ...
  return (
    <div className="relative bg-gradient-to-b from-[#0c0c1e] to-transparent h-[800px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center bottom-20">
        <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-b from-blue-200 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(59,130,246,0.6)]">
          Udem Entreprend
