...
function CommunitySection() {
  const eventImages = [
    "/Photo_evenement/Udem_Entreprend/T_M.webp",
  ...
  return (
    <section id="communaute" className="w-full py-20">
      <h2 className="text-center text-4xl md:text-5xl font-extrabold bg-gradient-to-b from-blue-200 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(59,130,246,0.6)]">
