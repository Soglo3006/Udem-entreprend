...
function BenevoleSection() {
  ...
  return (
    <div>
      <h1 className="text-3xl md:text-4xl font-bold text-center mt-10 tracking-wide text-blue-400 animate-pulse">
        Bénévole
      </h1>
      <div className="grid lg:grid-cols-2 items-center relative z-10">
            ...
            {benveloleImages.map((image, index) => (
              <SwiperSlide key={index}>
                <img
                  ...
                  className="w-auto h-[500px] rounded-xl object-cover"
                  loading="lazy"
                />
              </SwiperSlide>
            ))}
        ...
        <div id="benevole" className="md:text-left md:ml-20 text-center">
          <h1 className="text-3xl font-bold text-blue-300 mb-6 max-w-xl">
