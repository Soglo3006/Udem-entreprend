export const evenementsData = [
  ...
  },
  {
    ...
    description: "",
    resume:
      "Soirée réseautage collaborative entre Poly Entrepreneuriat et UdeM Entreprend, une opportunité unique pour connecter, échanger et s'inspirer. Cet événement permet aux étudiants d'élargir leur réseau professionnel, de discuter avec des experts et d'enrichir leurs chances d'obtenir des stages. Une occasion précieuse pour partager des idées et bâtir des connexions qui pourraient façonner l'avenir professionnel des participants.",
    partenaires: [
      {
        nom: "educalcool",
  ...
  description: "",
  resume: "Occasion parfaite pour rencontrer des entrepreneurs qui ont fait leur marque dans des secteurs variés : droit, médias, sciences, marketing, génie et bien plus. L'événement propose des discussions individuelles où chaque entrepreneur raconte son parcours et donne des conseils, un panel de discussion rassemblant tous les invités pour échanger sur les clés du succès entrepreneurial, et une soirée de réseautage avec nourriture incluse et tirages au sort.",
  partenaires: [{
    nom: "millenium",
    logo: "/Partenaires/millénium.webp",
    lien: "https://millenium.umontreal.ca/"
  ...
  video: null,
  galerie: [
    "/evenement/M1E/M1E_3E/Image/Photo1.jpg",
  ...
  description : "",
  resume: "Deuxième édition spéciale rassemblant une diversité de femmes entrepreneures et cadres venues partager leurs parcours, expériences et compétences. L'événement propose deux panel-discussions, un atelier pratique et une soirée de réseautage, le tout accompagné d'un dîner, de bouchées et de quelques surprises. Une occasion unique de s'inspirer de modèles féminins de réussite dans l'entrepreneuriat.",
  partenaires: [{
    nom: "millenium",
    logo: "/Partenaires/millénium.webp",
    lien: "https://millenium.umontreal.ca/"
  ...
  "description": "",
  "resume": "Deuxième édition de Meet1entrepreneur visant à promouvoir la relève d'affaires, transmettre les connaissances et développer les compétences entrepreneuriales. L'événement offre une occasion idéale d'échanger et de tisser des liens pour s'encourager mutuellement à prendre plus d'initiatives. Au programme : conférence inspirante, panel-jeunesse, réseautage/cocktail et autres surprises dans une ambiance conviviale.",
  "partenaires": [],
  "video": null,
  "galerie": [],
  "lieu": "Campus MIL",
  ...
  description: "",
  resume: "Première édition spéciale réunissant une variété de femmes entrepreneures et cadres venues mettre en lumière leurs parcours, expériences et expertises. L'événement propose des panel-discussions enrichissantes, un atelier pratique et une soirée de réseautage. Le dîner, des bouchées et d'autres surprises sont inclus, offrant un cadre convivial pour s'inspirer de modèles féminins de réussite.",
  partenaires: [{
    nom: "millenium",
    logo: "/Partenaires/millénium.webp",
    lien: "https://millenium.umontreal.ca/"
  ...
  description: "",
  resume: "Première édition de Meet1entrepreneur, une soirée conférence & réseautage conçue pour familiariser les étudiants à la culture entrepreneuriale. L'événement permet aux aspirants entrepreneurs de rencontrer des professionnels expérimentés qui renforcent leur enthousiasme pour l'entrepreneuriat. Focus sur le leadership, la gestion du temps et les parcours entrepreneuriaux, avec réseautage, cocktail et dégustation de petites bouchées.",
  partenaires: [{
    nom: "RBC",
